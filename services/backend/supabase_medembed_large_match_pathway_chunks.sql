...
create or replace function public.match_medembed_large_pathway_chunks(
...
grant execute on function public.match_medembed_large_pathway_chunks(vector, int, varchar)
